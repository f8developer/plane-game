...
namespace render {
    ...
    DLLEX void Clear();
    DLLEX void EndDraw();
    DLLEX void SetBackgroundColor(Color color);
    ...
    DLLEX void DrawTextPixelPerfect(Font font, const char* text, Vector2 position, float fontSize, float spacing, Color tint);
